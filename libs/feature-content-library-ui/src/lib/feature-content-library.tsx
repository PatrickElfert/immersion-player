...
function MediaCard({ name, thumbnail }: { name: string; thumbnail: string | null }) {
  const PlaceholderComponent = () => (
    <div className="w-[300px] h-[345px] bg-gray-100 border-2 border-gray-300 flex flex-col items-center justify-center">
      <PlayIcon className="w-16 h-16 text-gray-400 mb-4" />
      <span className="text-gray-500 text-sm">Generating thumbnail...</span>
    </div>
  );
